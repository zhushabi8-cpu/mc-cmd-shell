...
public class CommandHandler {
    ...
    public static final Map<UUID, String> LAST_FULL_OUTPUT = new HashMap<>();
    ...
    public static int executeHelp(CommandContext<ServerCommandSource> context) {
        ...
        if (!checkServerPermission(source, player)) {
            return 0;
        }

        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.help.title"));
        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.help.start"));
        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.help.run"));
        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.help.stop"));
        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.help.list"));
        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.help.confirm"));
        return 1;
    }
