...
public class CommandHandler {
    ...
    public static int executeShellHelp(CommandContext<ServerCommandSource> context) {
        ...
        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.cmd.help.start"));
        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.cmd.help.run"));
        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.cmd.help.stop"));
        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.cmd.help.clear"));
        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.shell.help.page"));
        source.sendMessage(ServerLanguageManage.getText("text.mc-cmd-shell.cmd.help.confirm"));
        return 1;
    }
}